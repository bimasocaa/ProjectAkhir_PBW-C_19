...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO anggota (nama, alamat, telepon, email) VALUES ('$nama', '$alamat', '$telepon', '$email')";
    if ($koneksi->query($sql)) {
        header("Location: indexanggota.php");
        exit;
    } else {
        $error = "Gagal menambah anggota: " . $koneksi->error;
    }
}
?>
...
<body class="min-h-screen bg-gradient-to-br from-orange-50 to-white p-6">
    <div class="max-w-xl mx-auto bg-white p-6 rounded shadow">
        <h1 class="text-2xl font-bold mb-6 text-orange-700">Tambah Anggota</h1>
        ...
        <form method="post" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="telepon" required class="w-full p-2 border rounded" />
            </div>

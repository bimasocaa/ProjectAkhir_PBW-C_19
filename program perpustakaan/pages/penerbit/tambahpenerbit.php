...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $koneksi->query("INSERT INTO penerbit (nama_penerbit, alamat) VALUES ('$nama', '$alamat')");
...
<body class="p-6">
    <h1 class="text-xl font-bold mb-4">Tambah Penerbit</h1>

    <form method="post" class="space-y-4 max-w-md">
        <div>
            <label>Nama Penerbit</label>
            <input type="text" name="nama_penerbit" required class="w-full p-2 border rounded" />
        </div>
        <div>
            <label>Alamat</label>
